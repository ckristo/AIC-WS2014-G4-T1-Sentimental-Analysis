...
import at.ac.tuwien.infosys.dsg.aic.ws2014.g4.t1.classifier.TwitterSentimentClassifier;
...
public class TwitterExample {
	...
	public static void main(String[] args) {
		...
		try {
			...
			TwitterSentimentClassifier cls = new TwitterSentimentClassifierImpl();
