...
All those specialities were already considered by our pre-processing step. In the following section we want to concentrate on the classification of already pre-processed tweets, were the stated specialities are already eliminated.
